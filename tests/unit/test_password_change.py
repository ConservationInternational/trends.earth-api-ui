...
class TestPasswordChange:
    ...
    def test_password_change_success(self, dash_app, mock_token, mock_user_data):
        ...
        with patch("trendsearth_ui.callbacks.profile.requests.post") as mock_post:
            mock_response = Mock()
            ...
            if callback_func:
                result = callback_func(n_clicks, current_password, new_password, confirm_password, token, user_data)
    ...
    def test_password_change_validation_errors(self, dash_app, mock_token, mock_user_data):
        ...
        if callback_func:
            ...
            result = callback_func(1, "old_pass", "new_pass", "different_pass", mock_token, mock_user_data)
    ...
    def test_password_change_api_error(self, dash_app, mock_token, mock_user_data):
        ...
        with patch("trendsearth_ui.callbacks.profile.requests.post") as mock_post:
            ...
            if callback_func:
                result = callback_func(1, "wrong_pass", "new_pass123", "new_pass123", mock_token, mock_user_data)
