...
class TestMockDataUsageExamples:
    ...
    def test_api_route_mocking_example(self, authenticated_page: Page):
        ...
        # The authenticated_page fixture handles all the API endpoint mocking
        # and navigates with mock_auth=1 to show the dashboard

        # The dashboard should be loaded with mock data
        ...
        assert authenticated_page.locator("[data-testid='dashboard-content']").is_visible()

    def test_manual_api_route_mocking_example(self, page: Page, live_server):
        """Example of how to manually set up API route mocking (alternative approach)."""
