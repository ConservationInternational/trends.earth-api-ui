    ...
    return {
        ...
        "scripts": {
            ...
            "secondary_columns": [
                ...
                {
                    "headerName": _("openEO Backend"),
                    "field": "openeo_backend_url",
                    "width": 200,
                    "cellStyle": {**TRUNCATED_CELL_STYLE, "fontSize": "11px"},
                    "tooltipField": "openeo_backend_url",
                    "resizable": True,
                    "filter": "agTextColumnFilter",
                    "filterParams": {
                        "buttons": ["clear", "apply"],
                ...
                {
                    "headerName": _("Batch Image"),
                    "field": "batch_image",
                    "width": 200,
                    "cellStyle": {**TRUNCATED_CELL_STYLE, "fontSize": "11px"},
                    "tooltipField": "batch_image",
                    "resizable": True,
                    "filter": "agTextColumnFilter",
                    "filterParams": {
                        "buttons": ["clear", "apply"],
