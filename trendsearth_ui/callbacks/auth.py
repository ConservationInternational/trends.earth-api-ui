...
def register_callbacks(app):
    ...
    def login_api(_n, email, password, remember_me, _api_environment_dropdown, search):
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                if user_data and access_token and refresh_token:
                    ...
                    return (
                        ...
                        None,
                        None,
                        _("Failed to retrieve user information."),
                        "danger",
                        True,
                    )
            else:
                ...
                try:
                    ...
                    if error_data.get("error_code") == "account_locked":
                        ...
                        if requires_reset:
                            ...
                            error_msg = _("Your account is temporarily locked. ") + _(
            ...
            return (
                ...
                None,
                None,
                _("Login failed: Connection timeout. Please try again later."),
                "danger",
                True,
            )
            ...
            return (
                ...
                None,
                None,
                _("Login failed: {error}").format(error=str(e)),
                "danger",
                True,
            )
    ...
    @app.callback(
        ...
        [
            ...
            State("register-email-notifications", "value"),
